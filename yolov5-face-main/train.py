...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/hub_v7/yolov7.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default=r"D:\帅璐宇\Tea\result\runs\train\yolo-28", help='save to project/name') #'runs/train' D:\帅璐宇\Tea\result\runs\train
