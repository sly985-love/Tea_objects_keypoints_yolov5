...
def detect(model, img0):
    ...
    return boxes
# python test_widerface.py --weights D:\茶叶嫩芽项目\结果\best-m\weights\best.pt   --save_folder runs/detect/tea_txt --dataset_folder D:\yolotea6\val3 --folder_pict D:\yolotea6\val.txt
