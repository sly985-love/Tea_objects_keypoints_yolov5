...
if __name__ == '__main__':
    ...
    root_path = r'C:\Users\shuailuyu\PycharmProjects\widerface'
    # if not os.path.isfile(os.path.join(root_path, 'WIDER_val', 'label.txt')):
    ...
    save_path = r'C:\Users\shuailuyu\PycharmProjects\widerface\WIDER_val\vallabel'

    datas = wider2face(root_path, phase='WIDER_val')
